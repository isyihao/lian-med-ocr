...
def parse_args():
    ...
    parser.add_argument('--chars_file', type=str, default='./data/chars/lian-med-dict.txt',
    ...
    parser.add_argument('--tag', type=str, default='test_1000/images', help='output images are saved under output_dir/{tag} dir')
